...
FASTRUN void ss_80coloff(bool data_phase) {}

FASTRUN void ss_80colon(bool data_phase) {}

FASTRUN void ss_altcharsetoff(bool data_phase) {}

FASTRUN void ss_altcharseton(bool data_phase) {}
...
FASTRUN void ss_bsrbank2(bool data_phase) {}

FASTRUN void ss_bsrreadram(bool data_phase) {}

FASTRUN void ss_ramrd(bool data_phase) {
  if (data_phase && bus_rw) {
    if (bus_data & 0x80) {
      ss_mode |= MF_AUXREAD;
    } else {
      ss_mode &= ~MF_AUXREAD;
...
FASTRUN void ss_vertblank(bool data_phase) {}
FASTRUN void ss_text(bool data_phase) {}
FASTRUN void ss_mixed(bool data_phase) {}
...
FASTRUN void ss_altcharset(bool data_phase) {}
FASTRUN void ss_80col(bool data_phase) {}
FASTRUN void ss_tapeout(bool data_phase) {}
FASTRUN void ss_monocolor(bool data_phase) {}
FASTRUN void ss_tbcolor(bool data_phase) {}
FASTRUN void ss_vgcint(bool data_phase) {}
FASTRUN void ss_mousedata(bool data_phase) {}
FASTRUN void ss_keymodreg(bool data_phase) {}
FASTRUN void ss_datareg(bool data_phase) {}
FASTRUN void ss_kmstatus(bool data_phase) {}
FASTRUN void ss_rombank(bool data_phase) {}
FASTRUN void ss_newvideo(bool data_phase) {}
FASTRUN void ss_langsel(bool data_phase) {}
FASTRUN void ss_charrom(bool data_phase) {}
FASTRUN void ss_sltromsel(bool data_phase) {}
FASTRUN void ss_vertcnt(bool data_phase) {}
FASTRUN void ss_horizcnt(bool data_phase) {}
FASTRUN void ss_spkr(bool data_phase) {}
FASTRUN void ss_diskreg(bool data_phase) {}
FASTRUN void ss_scanint(bool data_phase) {}
FASTRUN void ss_clockdata(bool data_phase) {}
FASTRUN void ss_clockctl(bool data_phase) {}
FASTRUN void ss_shadow(bool data_phase) {}
FASTRUN void ss_cyareg(bool data_phase) {}
FASTRUN void ss_bmareg(bool data_phase) {}
FASTRUN void ss_sccbreg(bool data_phase) {}
FASTRUN void ss_sccareg(bool data_phase) {}
FASTRUN void ss_sccbdata(bool data_phase) {}
FASTRUN void ss_sccadata(bool data_phase) {}
FASTRUN void ss_soundctl(bool data_phase) {}
FASTRUN void ss_sounddata(bool data_phase) {}
FASTRUN void ss_soundadrl(bool data_phase) {}
FASTRUN void ss_soundadrh(bool data_phase) {}
FASTRUN void ss_strobe(bool data_phase) {}
FASTRUN void ss_rdvblmsk(bool data_phase) {}
FASTRUN void ss_rdx0edge(bool data_phase) {}
FASTRUN void ss_rdy0edge(bool data_phase) {}
FASTRUN void ss_mmdeltax(bool data_phase) {}
FASTRUN void ss_mmdeltay(bool data_phase) {}
FASTRUN void ss_diagtype_intflag(bool data_phase) {}
FASTRUN void ss_clrvblint(bool data_phase) {}
FASTRUN void ss_clrxyint(bool data_phase) {}
FASTRUN void ss_emubyte(bool data_phase) {}
FASTRUN void ss_textoff(bool data_phase) {}
FASTRUN void ss_texton(bool data_phase) {}
FASTRUN void ss_mixedoff(bool data_phase) {}
FASTRUN void ss_mixedon(bool data_phase) {}
...
FASTRUN void ss_clran0(bool data_phase) {}
FASTRUN void ss_setan0(bool data_phase) {}
FASTRUN void ss_clran1(bool data_phase) {}
FASTRUN void ss_setan1(bool data_phase) {}
FASTRUN void ss_clran2(bool data_phase) {}
FASTRUN void ss_setan2(bool data_phase) {}
FASTRUN void ss_dhireson(bool data_phase) {}
FASTRUN void ss_dhiresoff(bool data_phase) {}
FASTRUN void ss_tapein_butn3(bool data_phase) {}
FASTRUN void ss_rdbtn0(bool data_phase) {}
FASTRUN void ss_butn1(bool data_phase) {}
FASTRUN void ss_rd63(bool data_phase) {}
FASTRUN void ss_paddl0(bool data_phase) {}
FASTRUN void ss_paddl1(bool data_phase) {}
FASTRUN void ss_paddl2(bool data_phase) {}
FASTRUN void ss_paddl3(bool data_phase) {}
FASTRUN void ss_statereg(bool data_phase) {}
FASTRUN void ss_testreg(bool data_phase) {}
FASTRUN void ss_clrtm(bool data_phase) {}
FASTRUN void ss_banksel(bool data_phase) {}
FASTRUN void ss_blossom(bool data_phase) {}
FASTRUN void ss_ioudison(bool data_phase) {}
FASTRUN void ss_ioudisoff(bool data_phase) {}
...
FASTRUN void emit_data(uint8_t data, bool assert_inhibit) {
  // TODO: figure out what to do for assert_inhibit
  // TODO: figure out what to do for emit data
}

FASTRUN void zp_stack_func(uint16_t addr, uint8_t data, bool data_phase) {
  uint32_t dest_addr = addr;
  if (ss_mode & MF_ALTZP) {
    dest_addr += 0x10000;
  }
  if (data_phase) {
    apple_main_memory[dest_addr] = data;
  } else {
    if (bus_rw && brain_transplant_mode) {
      emit_data(apple_main_memory[dest_addr], true);
    }
  }
}

FASTRUN void main_memory_func(uint16_t addr, uint8_t data, bool data_phase) {
  uint32_t dest_addr = addr;
  if (data_phase) {
    if (prev_bus_rw) {
...
FASTRUN void main_memory_80store(uint16_t addr, uint8_t data, bool data_phase) {
  uint32_t dest_addr = addr;
  if (ss_mode & MF_PAGE2) {
    dest_addr += 0x10000;
  }
...
FASTRUN void high_memory_banked(uint16_t addr, uint8_t data, bool data_phase) {
}

FASTRUN void high_memory_unbanked(uint16_t addr, uint8_t data, bool data_phase) {
}

// FASTRUN main_rom_func(uint16_t addr, uint8_t data, bool data_phase) {
//   if (data_phase) {
//     if (!prev_bus_rw) {
//       main_rom[addr - 0xc100] = data;
//     }
//   }
// }

// FASTRUN handle_card_page_func(uint16_t addr, uint8_t data, bool data_phase) {
...
//     }
//   } else {
//     is_slot_access = ((ss_mode & MF_INTCXROM) == 0);
//   }
//   if (is_slot_access) {
//     card_shared_owner = slot_number;
//     (*(handle_card_page_event)[slot_number])(addr, data, data_phase);
//   } else {
//     main_rom_func(addr, data, data_phase);
//   }
//   return true;
// }

// FASTRUN handle_card_shared_func(uint16_t addr, uint8_t data, bool data_phase) {
//   if (addr == 0xcfff) {
//     card_shared_owner = -1;
//     ss_mode &= ~MF_INTC8ROM;
//   }
//   if (card_shared_owner) {
//     handle_card_shared_event[card_shared_owner](addr, data, data_phase);
//   }
// }

// void initialize_memory_page_handlers() {
//   // ZP and stack
//   memory_page_callback[0] = &zp_stack_func;
//   memory_page_callback[1] = &zp_stack_func;
//   for (int i = 2; i < 0xc0; ++i) {
//     memory_page_callback[i] = &main_memory_func;
//   }
//   for (int i = 4; i < 8; ++i) {
//     memory_page_callback[i] = &main_memory_80store;
//   }
//   for (int i = 0x20; i < 0x40; ++i) {
//     memory_page_callback[i] = &main_memory_80store;
//   }
//   memory_page_callback[0xc0] = &soft_switch_io_func;
//   for (int i = 1; i < 8; ++i) {
//     memory_page_callback[0xc0 + i] = &handle_card_page_func;
//   }
//   for (int i = 8; i < 16; ++i) {
//     memory_page_callback[0xc0 + i] = &handle_card_shared_func;
//   }
//   for (int i = 0xd0; i < 0xe0; ++i) {
//     memory_page_callback[i] = &high_memory_banked;
//   }
//   for (int i = 0xe0; i < 0x100; ++i) {
//     memory_page_callback[i] = &high_memory_unbanked;
//   }
// }
